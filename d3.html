...
var colors = {
  "North America": "#5687d1",
  "Africa": "#7b615c",
  "Asia": "#de783b",
  "Europe": "#6ab975",
  "South America": "#a173d1",
  "Oceania": "#bbbbbb",
  "Drama": "#a173d1"
};

var colors10 = d3.scale.category20();
...
d3.text("resources/genre english.csv", function(text) {
...
function createVisualization(json) {
  ...
  var path = vis.data([json]).selectAll("path")
      ...
      .style("fill", function(d,i) {
          if(d.name !== "root") {
              var index = d.parent.children.findIndex(function(element) {
